    ...
    public struct Subscription: Encodable, RequestParameterAPIOperationPropertiesSupport {
        ...
        public func getProperties() -> [String: Any] {
            ...
            return  [
                ...
                "id":                       "follow",
                "json":                     isWhatNil ? "[\"follow\",{\"follower\":\"\(self.follower)\",\"following\":\"\(self.authorNickame)\",\"what\":[]}]" :
                                                        "[\"follow\",{\"follower\":\"\(self.follower)\",\"following\":\"\(self.authorNickame)\",\"what\":[\"\(self.what!)\"]}]"
            ]
        }
