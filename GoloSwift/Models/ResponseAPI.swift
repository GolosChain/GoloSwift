...
// MARK: -
public struct ResponseAPIUserRepliesResult: Decodable {
    // MARK: - In work
    public let id: Int64
    public let jsonrpc: String
    public let result: [ResponseAPIUserReply]?
    public let error: ResponseAPIError?
}


// MARK: -
public struct ResponseAPIUserReply: Decodable {
    // MARK: - In work
    // swiftlint:disable identifier_name
    public let id: Int64
    public let body: String
    ...
    // MARK: - In reserve
    /*
     public let "abs_rshares" = 0;
     public let active = "2018-07-04T06:29:45";
     public let "active_votes" =     (
     );
     public let "active_votes_count" = 0;
     public let "allow_curation_rewards" = 1;
     public let "allow_replies" = 1;
     public let "allow_votes" = 1;
     public let author = arcange;
     public let "author_reputation" = 1401180461186355;
     public let "author_rewards" = 0;
     public let beneficiaries =     (
     );
     public let "body_length" = 0;
     public let "cashout_time" = "2018-07-11T06:29:45";
     public let category = test;
     public let children = 0;
     public let "children_abs_rshares" = 0;
     public let "children_rshares2" = 0;
     public let "curator_payout_value" = "0.000 GBG";
     public let depth = 1;
     public let "json_metadata" = "";
     public let "last_payout" = "1970-01-01T00:00:00";
     public let "last_update" = "2018-07-04T06:29:45";
     public let "max_accepted_payout" = "1000000.000 GBG";
     public let "max_cashout_time" = "1969-12-31T23:59:59";
     public let mode = "first_payout";
     public let "net_rshares" = 0;
     public let "net_votes" = 0;
     public let "parent_author" = destroyer2k;
     public let "parent_permlink" = "what-is-it";
     public let "pending_payout_value" = "0.000 GBG";
     public let "percent_steem_dollars" = 10000;
     public let permlink = "re-what-is-it-20180702t082945000z";
     public let promoted = "0.000 GBG";
     public let "reblogged_by" =     (
     );
     public let replies =     (
     );
     public let "reward_weight" = 10000;
     public let "root_comment" = 5397622;
     public let "root_title" = "What is it?";
     public let title = "";
     public let "total_payout_value" = "0.000 GBG";
     public let "total_pending_payout_value" = "0.000 GBG";
     public let "total_vote_weight" = 0;
     public let "vote_rshares" = 0;
    */
    // swiftlint:enable identifier_name
}
